...
const zh: Record<string, string> = {
  ...
  'init plugins': '初始化插件',
  'collect & goal loop': '采集与目标循环',
  'shutdown': '收尾',
  'No events recorded for this run.': '该 run 无事件记录。',
  'Coverage turns': '覆盖率轮次',
  'coverage': '覆盖率',
  'progress': '进展',
  '{n} turns': '{n} 轮',
  'running…': '执行中…',
  'Scenarios (in-run)': '场景执行（run 内）',
  'scenario': '场景',
  'Analysis report': '分析报告',
  // —— Scenario 回放历史 ——
  'Replay history': '回放历史',
  'No scenario replays yet — click Replay above.': '还没有场景回放 —— 点击上方 Replay 生成。',
  'replayed at': '回放时间',
  'detail': '明细',
  'I/O': 'I/O',
  'input': '输入',
  'n/a': '—',
  // —— Pipeline 原始事件 I/O ——
  'Raw events (I/O)': '原始事件（I/O）',
  'show raw events (I/O)': '查看原始事件（I/O）',
  'hide raw events': '收起原始事件',
  'truncated — showing first {n} events': '已截断 —— 仅显示前 {n} 条事件',
  '#': '#',
  'time': '时间',
  'payload': '载荷',
}
